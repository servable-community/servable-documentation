...
We want to build a Servable app that:
- #TODO
...
By default a Servable app contains the following classes: *_User, _Session, _Installation, ServableApp*
Add a custom class:
...
:::note
You can add class manually by adding a class payload to the lib/app/schema/1.0.0/index.json
:::
